...
--------------------
01d,30apr02,dat  Merge with cpn5360, removed support for old BSD driver
01c,01feb00,djs  incorporate WRS review comments.
01b,07jun99,scb  Port from T1 to T2.
01a,07jun99,scb  written from pcPentium version (01s,12mar99,jkf)
*/

/*
Currently, this module only supports the Intel EtherExpress PRO100B LAN
Adapter.  If support for more 82557-based adapters is desired, this module
must be modified.
...
/* Do nothing if FEI_END not defined */

#ifdef INCLUDE_FEI_END  /* END-style Intel 82557 (Fast EI) Support */
...
LOCAL FEI_RESOURCE feiResources [FEI_MAX_UNITS] =
    ...
    {FEI0_MEMBASE0, FEI0_IOBASE0, FEI0_MEMBASE1, FEI0_INT_LVL, UNKNOWN,
     UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, {UNKNOWN}, UNKNOWN, {UNKNOWN}, NULL, 
     FEI0_MEMSIZE0, FEI0_INIT_STATE_MASK, FEI0_INIT_STATE},
    {FEI1_MEMBASE0, FEI1_IOBASE0, FEI1_MEMBASE1, FEI1_INT_LVL, UNKNOWN,
     UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, {UNKNOWN}, UNKNOWN, {UNKNOWN}, NULL, 
     FEI1_MEMSIZE0, FEI1_INIT_STATE_MASK, FEI1_INIT_STATE},
    {FEI2_MEMBASE0, FEI2_IOBASE0, FEI2_MEMBASE1, FEI2_INT_LVL, UNKNOWN,
     UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, {UNKNOWN}, UNKNOWN, {UNKNOWN}, NULL,
     FEI2_MEMSIZE0, FEI2_INIT_STATE_MASK, FEI2_INIT_STATE},
    {FEI3_MEMBASE0, FEI3_IOBASE0, FEI3_MEMBASE1, FEI3_INT_LVL, UNKNOWN,
     UNKNOWN, UNKNOWN, UNKNOWN, UNKNOWN, {UNKNOWN}, UNKNOWN, {UNKNOWN}, NULL,
     FEI3_MEMSIZE0, FEI3_INIT_STATE_MASK, FEI3_INIT_STATE},
#else
	{0}
#endif
     };
...
void sys557PciInit (void)
	...
	/* force Cache Line Size to 8 double-words */
...
#if (PCI_CFG_TYPE==PCI_CFG_NONE)
        if (sysMmuMapAdd((void *)membaseCsr, pReso->memLength,
                          pReso->initialStateMask, 
                          pReso->initialState) == ERROR)
            break; 
#endif
...
LOCAL UINT16 sys557eepromRead
    ...
    {
    UINT16 iobase = feiResources[unit].iobaseCsr;
    UINT16 retval = 0;
    UINT16 dataval;
...
void sys557Show
    ...
    printf ("82557(%d): Intel EtherExpress Pro 10/100 at %#3x ", unit, iobase);
    for (ix = 0; ix < 5; ix++)
