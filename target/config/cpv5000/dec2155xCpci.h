...
--------------------
01d,29apr02,mil  Cleaned up compiler warnings.
01c,21mar00,scb  Add hardwired upstream CSR setup values.
01b,08jun99,scb  Moved from T1 base to T2 base.
01a,24nov98,scb  Motorola initial derivation from MCP750/MCPN750 base.
*/

#ifndef __INCdec2155xCcpih
#define __INCdec2155xCcpih
...
#define PCI_ID_VEND_DEC21554      0x1011
#define PCI_ID_DEV_DEC21554       0x0046
#ifndef PCI_ID_BR_DEC21554
#   define PCI_ID_BR_DEC21554 \
           ( (PCI_ID_DEV_DEC21554 << 16) | (PCI_ID_VEND_DEC21554) )
#endif  /* PCI_ID_BR_DEC21554 */
...
/* Hardwired setup value for upstream CSR BARs (memory and I/O) */

#define DEC2155X_US_CSR_MEM_SETUP	        0xfffff000
#define DEC2155X_US_CSR_IO_SETUP	        0xffffff01
...
/* DEC2155X Control and Status Registers (CSR) */
